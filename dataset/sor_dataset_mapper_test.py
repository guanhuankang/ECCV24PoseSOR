...
def sor_dataset_mapper_test(image_dict, cfg):
    ...
    transform = A.Compose([
        ...
        A.Resize(cfg.INPUT.TEST_IMAGE_SIZE, cfg.INPUT.TEST_IMAGE_SIZE)
    ],
    ...
    return {
        ...
        "bboxes": bboxes,  ## K, 4: xyhw [0.0, 1.0], where x,y is the center point
